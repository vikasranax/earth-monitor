...
export const modules: ModuleInfo[] = [
  ...
  { id: "M05", name: "Global Map & Country Intel", status: "standby" },
  { id: "M05a", name: "Multilayer Map Engine", status: "standby" },
  { id: "M06", name: "News Engine", status: "standby" },
  { id: "M07", name: "Markets Suite", status: "standby" },
  { id: "M08", name: "Shipping & Straits", status: "standby" },
  { id: "M09", name: "Airspace", status: "standby" },
  { id: "M09a", name: "Hazard & Disaster Layer", status: "standby" },
  { id: "M09b", name: "Infrastructure & Outages", status: "standby" },
  { id: "M10", name: "Thematic Dashboards", status: "standby" },
  { id: "M11", name: "Alerts · Auth · Personalisation", status: "standby" },
  { id: "M12", name: "AI Copilot", status: "standby" },
